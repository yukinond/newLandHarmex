document.addEventListener('DOMContentLoaded', function() {
            ...
            let currentIndex = 1; // Центральный слайд
            const slideWidth = slides[0].offsetWidth + 32; // Ширина слайда + gap
            ...
            function updateSlider() {
                ...
                // Сдвигаем контейнер, чтобы центральный слайд был по центру
                const offset = -currentIndex * slideWidth + (slider.parentElement.offsetWidth / 2 - slideWidth / 2);
                ...
                slides.forEach((slide, index) => {
                    ...
                    // Обновляем высоту центрального слайда
                    if (index === currentIndex) {
                        slide.style.height = '520px';
                        slide.querySelector('.gradient').style.background = 'linear-gradient(180deg, rgba(27, 91, 247, 0) 70.16%, rgba(27, 91, 247, 0.7) 99.93%)';
                    } else {
                        slide.style.height = '486px';
                        slide.querySelector('.gradient').style.background = 'linear-gradient(180deg, rgba(27, 91, 247, 0) 70.16%, rgba(0, 0, 0, 0.7) 99.93%)';
                    }
                });
